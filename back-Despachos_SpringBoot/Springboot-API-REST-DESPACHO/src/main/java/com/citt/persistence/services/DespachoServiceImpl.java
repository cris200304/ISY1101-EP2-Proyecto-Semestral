...
public class DespachoServiceImpl implements DespachoService {
        ...
        return despachoRepository.findById(idDespacho)
                .map(existingDespacho -> {
                    ...
                    return despachoRepository.save(existingDespacho);
                        ...
                        new DespachoNotFoundException(
                                "Despacho no encontrado con ID: " + idDespacho));
    }
    ...
    public void deleteDespacho(Long idDespacho)
        ...
        if (despacho.isEmpty()) {
            throw new DespachoNotFoundException(
                    "¡No es posible eliminar! No existe despacho con el ID: "
                            + idDespacho);
        }
